...
1. Define the variables for epochs, neurons in hidden layers and learning rate variables.
2. Define the input features and labels, weights and biases for the first and second layer, the activation function after the first layer and the activation function for the output layer.
